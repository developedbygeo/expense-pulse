...
import { MdCheck, MdCircle, MdOutlineKeyboardArrowRight } from 'react-icons/md'
...
>(({ className, inset, children, ...props }, ref) => (
    ...
    >
        {children}
        <MdOutlineKeyboardArrowRight className="ml-auto h-4 w-4" />
    </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
        ref={ref}
        className={cn(
            'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-neutral-200 focus:text-neutral-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-neutral-200',
            inset && 'pl-8',
            className
        )}
        {...props}
