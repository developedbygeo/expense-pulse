...
import { LOGIN_FIELD_NAMES, REGISTER_FIELD_NAMES } from '@/types/data/enums/auth';
...
export const RegisterUserSchema: ZodType<RegisterUser> = z
  .object({
    ...
    [REGISTER_FIELD_NAMES.ALLOWANCE]: z.number().min(100, { message: 'Allowance must be at least 100.' }),
