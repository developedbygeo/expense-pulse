...
export const items = [
  ...
  {
    description: <DonutChart series={[60, 40]} labels={['Total Expenses', 'Remaining Allowance']} />,
  },
  ...
  },
  {
    ...
    description: <BaseChart options={mockHomeBar.options} series={mockHomeBar.series} />,
  },
];
